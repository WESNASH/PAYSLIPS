...
def send_email(employee_email, employee_name, payslip_path):
    msg = MIMEMultipart()
    msg['From'] = 'tadiwanash6@gmail.com'  # Your email address
    ...
    email_user = 'tadiwanash6@gmail.com'  # Your email address
    email_password = 'Residuals@21'  # Replace with your email password or App Password
...
send_email('tadiwanash6@gmail.com', 'Employee Name', 'payslip.pdf')
