...
##Emailing Payslips
def send_email(self, employee, attachment_path):
        """Send email with payslip using yagmail"""
        try:
    ...
    def process_all_employees(self):
        """Process all employees - generate payslips and send emails"""
        ...
        for _, employee in self.employees.iterrows():
            try:
                ...
                if payslip_path:
                    self.send_email(employee, payslip_path)
            except Exception as e:
